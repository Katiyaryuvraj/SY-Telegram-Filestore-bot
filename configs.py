...
╭────[ **🔅FɪʟᴇSᴛᴏʀᴇBᴏᴛ🔅**]────⍟
│
├🔸🤖 **My Name:** [**SY Telegram Filestore bot**](https://t.me/{BOT_USERNAME})
│
...
│
├🔸👨‍💻 **Developer:** [**SY_Entertainments**](https://t.me/SY_Entertainments) 
│
├🔹👥 **Bot Support:** [𝐒𝐮𝐩𝐩𝐨𝐫𝐭](https://t.me/SY_Bots)
│
├🔸🔔 **Bot Updates:** [𝐔𝐩𝐝𝐚𝐭𝐞𝐬](https://t.me/SY_Bots)
│
╰──────[ 😎 ]───────────⍟
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿:** [**@Its_hackers_arena**](https://t.me/Its_hackers_arena) 
...
"""
	HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **Telegram Filestore bot** by @SY_Entertainments.
