    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Movies/Series Channel", url="https://t.me/SY_Entertainments")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Movies/Series Channel", url="https://t.me/SY_Entertainments"),
                        InlineKeyboardButton("Bots Channel", url="https://t.me/SY_Bots")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/SY_Bots)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://telegram.me/{Config.BOT_USERNAME}?start=SY-Entertainments_{str_to_b64(file_er_id)}"
    ...
    if "aboutbot" in cb_data:
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/SY_Bots).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
